...
--      ⚠️⚠️ **[2026-09-22 정정] 이 문장은 틀렸다.** 두 학교는 같은 교과서를 쓴다
--      (2015 개정 천재교육 박영목 외). 교과서 수록작 목록과 대조하니 위 셋은 전부
--      **광희중 쪽이 오기**였고 sql/43 이 행당중 표기로 합쳤다. 이 파일의 나머지
--      판단은 그대로 유효하다 — 이 규칙 ③ 만 무효다.
