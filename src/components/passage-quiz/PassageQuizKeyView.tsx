 ...
 * 정답 아래에 **지문 근거**를 함께 싣는다. AI 가 만든 문항이라 채점하는 사람이
 * "지문 어디에 그렇게 적혀 있나" 를 바로 확인할 수 있어야 한다.
 */
...
/**
 * 정답표를 A4 쪽으로 그린다.
 * @param props - 제목과 문항 목록
 * @returns 인쇄용 문서
 */
export default function PassageQuizKeyView({ title, items }: PassageQuizKeyViewProps) {
